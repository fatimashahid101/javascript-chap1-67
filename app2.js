...
function changeImage(){
    ...
    car_image.src = 'https://mettisglobal.news/wp-content/uploads/2018/04/IMG642JSCL-696x438.png'
}
function changeImageBefore(){
    var car_image = document.getElementById('img')
    car_image.src = 'https://4.bp.blogspot.com/-s2EhTt57oeU/XHtQtO1QNLI/AAAAAAAANW8/KYkPQEZUyocSpA2RzqCcVt31imXPi63RACLcBGAs/s1600/Free%2BCourses%2Bto%2Blearn%2BJavaScript.jpg'
}
//task 5
var counter = 0;
...
var firstName = document.getElementById('first-name').value = 'Fatima'
var LastName = document.getElementById('last-name').value = 'Shahid'
var email= document.getElementById("email").value = 'fatimaShahid600@gmail.com'
...
var Contact = document.getElementById("Contact").value = '+92 300 1234567'
 ...
 document.write(lastName.childNodes[1].nodeType)
 document.write(lastName.childNodes[2].nodeType)
 var mainContent = document.getElementById("main-content");
 document.write(mainContent.firstChild);
 document.write(mainContent.lastChild);
 var last_Name = document.getElementById("lastName");
 document.write(last_Name.nextSibling);
 document.write(last_Name.previousSibling);
 var email = document.getElementById("email").parentNode.nodeValue
